...
HalfcosbasisOptions* HalfcosbasisOptions::gopt = NULL;

void HalfcosbasisOptions::parse_command_line(int argc, char** argv, Log& logger)
{
  Tracer_Plus("HalfcosbasisOptions::parse_command_line");
