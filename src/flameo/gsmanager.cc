...
// 	OUT(zts[t].zdim());
  ...
  void Gsmanager::save()
  {
    ...
    design.saveVolumeAsFile(res, LogSingleton::getInstance().appendDir("res4d"),design.getmask());      
    ...
    design.saveVolumeAsFile(design.getmask(), LogSingleton::getInstance().appendDir("mask"),design.getmask());

    for(int t = 0; t < design.getnumtcontrasts(); t++)
      {	
	ts[t].set_intent(NIFTI_INTENT_TTEST, 0, 0, 0);
	ts[t].setDisplayMaximumMinimum(ts[t].max(),ts[t].min());
	design.saveVolumeAsFile(ts[t],LogSingleton::getInstance().appendDir("tstat"+num2str(t+1)),design.getmask());

	tdofs[t].set_intent(NIFTI_INTENT_NONE, 0, 0, 0);
	tdofs[t].setDisplayMaximumMinimum(tdofs[t].max(),tdofs[t].min());
	design.saveVolumeAsFile(tdofs[t],LogSingleton::getInstance().appendDir("tdof_t"+num2str(t+1)),design.getmask());
...
// 	OUT(zts[t].max());
// 	OUT(min); OUT(max);
	design.saveVolumeAsFile(zts[t],LogSingleton::getInstance().appendDir("zstat"+num2str(t+1)),design.getmask());
	...
	design.saveVolumeAsFile(zflame1upperts[t],LogSingleton::getInstance().appendDir("zflame1uppertstat"+num2str(t+1)),design.getmask());
	...
	design.saveVolumeAsFile(zflame1lowerts[t],LogSingleton::getInstance().appendDir("zflame1lowertstat"+num2str(t+1)),design.getmask());

	tcopes[t].set_intent(NIFTI_INTENT_ESTIMATE, 0, 0, 0);
	tcopes[t].setDisplayMaximumMinimum(tcopes[t].max(),tcopes[t].min());
	design.saveVolumeAsFile(tcopes[t],LogSingleton::getInstance().appendDir("cope"+num2str(t+1)),design.getmask());

	tvarcopes[t].set_intent(NIFTI_INTENT_ESTIMATE, 0, 0, 0);
	tvarcopes[t].setDisplayMaximumMinimum(tvarcopes[t].max(),tvarcopes[t].min());
	design.saveVolumeAsFile(tvarcopes[t],LogSingleton::getInstance().appendDir("varcope"+num2str(t+1)),design.getmask());
	...
	design.saveVolumeAsFile(fs[f],LogSingleton::getInstance().appendDir("fstat"+num2str(f+1)),design.getmask());
	...
	design.saveVolumeAsFile(zflame1upperfs[f],LogSingleton::getInstance().appendDir("zflame1upperfstat"+num2str(f+1)),design.getmask());
	...
	design.saveVolumeAsFile(zflame1lowerfs[f],LogSingleton::getInstance().appendDir("zflame1lowerfstat"+num2str(f+1)),design.getmask());

	fdof1s[f].set_intent(NIFTI_INTENT_NONE, 0, 0, 0);
	fdof1s[f].setDisplayMaximumMinimum(fdof1s[f].max(),fdof1s[f].min());
	design.saveVolumeAsFile(fdof1s[f],LogSingleton::getInstance().appendDir("fdof1_f"+num2str(f+1)),design.getmask());

	fdof2s[f].set_intent(NIFTI_INTENT_NONE, 0, 0, 0);
	fdof2s[f].setDisplayMaximumMinimum(fdof2s[f].max(),fdof2s[f].min());
	design.saveVolumeAsFile(fdof2s[f],LogSingleton::getInstance().appendDir("fdof2_f"+num2str(f+1)),design.getmask());

	zfs[f].set_intent(NIFTI_INTENT_ZSCORE, 0, 0, 0);
	zfs[f].setDisplayMaximumMinimum(zfs[f].max(),zfs[f].min());
	design.saveVolumeAsFile(zfs[f],LogSingleton::getInstance().appendDir("zfstat"+num2str(f+1)),design.getmask());
      ...
      for(int e = 0; e < nevs; e++)
	{
	  ...
	  design.saveVolumeAsFile(pes[e],LogSingleton::getInstance().appendDir("pe"+num2str(e+1)),design.getmask());
	}
	...
	design.saveVolumeAsFile(beta_mean[g],LogSingleton::getInstance().appendDir("mean_random_effects_var"+num2str(g+1)),design.getmask());

	weights[g].set_intent(NIFTI_INTENT_ESTIMATE, 0, 0, 0);
	weights[g].setDisplayMaximumMinimum(weights[g].max(),weights[g].min());
	design.saveVolumeAsFile(weights[g],LogSingleton::getInstance().appendDir("weights"+num2str(g+1)),design.getmask());
	...
	if(opts.infer_outliers.value())
	  {
	    ...
	    design.saveVolumeAsFile(beta_outlier_mean[g],LogSingleton::getInstance().appendDir("mean_outlier_random_effects_var"+num2str(g+1)),design.getmask());
	    ...
	    design.saveVolumeAsFile(global_prob_outlier_mean[g],LogSingleton::getInstance().appendDir("global_prob_outlier"+num2str(g+1)),design.getmask());
	    ...
	    design.saveVolumeAsFile(prob_outlier_mean[g],LogSingleton::getInstance().appendDir("prob_outlier"+num2str(g+1)),design.getmask());
