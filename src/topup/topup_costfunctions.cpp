                                                                  ...
                                                                  const BASISFIELD::splinefield& field) const
{
  ...
  copybasicproperties(*_smooth,df);
...
void TopupCF::WriteUnwarped(const std::string& fname) const
{
  ...
  std::vector<unsigned int> imsz = _sm.ImageSize(Target);
			 ...
			 const NEWIMAGE::volume4D<float>& hdr) const
{
  ...
  TopupFileWriter  write_it(fname,hdr,_field);
                                               ...
                                               const BASISFIELD::splinefield&  field) const
{
  ...
  std::vector<unsigned int> isz = _sm.ImageSize(Target);
